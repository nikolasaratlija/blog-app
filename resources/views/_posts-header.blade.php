        ...
        <div class="relative flex lg:inline-flex items-center bg-gray-100 rounded-xl">
            <div x-data="{ show: false }" @click.away="show = false">
                ...
                <div x-show="show" class="py-2 absolute bg-gray-100 mt-2 rounded-xl w-full z-50">
                    <a href="/"
                        class="block text-left px-3 text-sm leading-6 hover:bg-blue-500 focus:bg-blue-500 hover:text-white focus:text">All</a>

                    @foreach ($categories as $category)
                        <a href="/categories/{{ $category->slug }}"
                            class="block text-left px-3 text-sm leading-6 hover:bg-blue-500 focus:bg-blue-500 hover:text-white focus:text
